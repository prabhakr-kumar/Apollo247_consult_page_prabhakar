...
//		System.setProperty("webdriver.chrome.driver", "C:\\Users\\pkum1389\\eclipse-workspace\\Apollo_Dcotor_consult_prabhakar\\drivers\\chromedriver.exe");
//		driver=new ChromeDriver();

		objectMethod();
		Thread.sleep(5000);
		String actualtitle = ldp.validateLandingPageTitle();
		String expectedtitle = "Apollo 247 Page"; 
